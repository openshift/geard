...
Utility command which switches into a specified docker container's namespace and execute
a command. It allows two use-cases:
...
>     switchns --container=gear-0001 --env="FOO=BAR" --env="BAZ=ZAB" -- /bin/bash \
>       -c "echo \$FOO \$BAZ"
> 
